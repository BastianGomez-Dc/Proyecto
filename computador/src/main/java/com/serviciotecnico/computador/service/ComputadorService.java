...
public class ComputadorService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ComputadorService.class);
    ...
    public Computador actualizarComputador(UUID id, ComputadorRequest request) {
        ...
        computadorRepository.save(existente);
        return existente;
    }

    public void eliminarComputador(UUID id) {
        obtenerPorId(id);
