...
public class UsuarioController {
    ...
    @GetMapping("/{rut}/computadores")
    public List<ComputadorDto> obtenerComputadores(@PathVariable String rut) {
        return usuarioService.obtenerComputadoresPorUsuario(rut.toUpperCase());
    }

    @GetMapping("/{rut}/servicios")
    public List<MantencionDto> obtenerServicios(@PathVariable String rut) {
        return usuarioService.obtenerServiciosPorUsuario(rut.toUpperCase());
    }
}
